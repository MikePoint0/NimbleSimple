...
class AppButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        gradient: buttonType == ButtonType.primary ? buttonType.defaultGradient : null,
        color: buttonType == ButtonType.primary ? null : buttonType.defaultColor,
