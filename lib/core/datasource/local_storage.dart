...
import '../../screens/main/model/PurchaseList.dart';
...
class LocalStorage {
 ...
 return   await sharedPreferences.setBool(key, value);
  ...
  Future writeObject({required String key, required AuthResultModel value}) async {
  ...
  Future writeSecureObject({required String key, required PurchaseList? value}) async {
    await flutterSecureStorage.write(key: key, value: jsonEncode(value!.toJson()));
  }

  Future<PurchaseList?> readSecureObject(String key) async {
    ...
    return PurchaseList.fromJson(jsonDecode(user!));
  }
