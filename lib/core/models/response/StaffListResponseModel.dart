class StaffListResponseModel {
  ...
  StaffListResponseModel({this.status, this.message, this.staffListResponseModelData});

  StaffListResponseModel.fromJson(Map<dynamic, dynamic> json) {
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      staffListResponseModelData = <StaffListResponseModelData>[];
      json['data'].forEach((v) {
        staffListResponseModelData!.add(new StaffListResponseModelData.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.staffListResponseModelData != null) {
      data['data'] = this.staffListResponseModelData!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
