...
generateBearerToken() async {
  ...
  //   BusinessType loginType = GetIt.I.get<User>().loginType;
  //
...
Future refreshUnifiedToken() async {
  // if (!GetIt.I.isRegistered<UnifiedToken>()) return;
  // UnifiedToken unifiedToken = GetIt.I.get<UnifiedToken>();
  //
  ...
  //       );
  //       if (GetIt.I.isRegistered<UnifiedToken>()) {
  //         GetIt.I.unregister<UnifiedToken>();
  //       }
  //       GetIt.I.registerSingleton<UnifiedToken>(token);
  //     }
  //   }
  // } catch (err) {}
}
