  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        if (title.isNotEmpty)
          Padding(
            padding: EdgeInsets.only(bottom: subtitle.isEmpty ? 8.h : 0),
            child: RichText(
              maxLines: 2,
              ...
              text: TextSpan(
                ...
                style: AppStyle.text1.copyWith(color: AppColors.sonaBlack2, fontWeight: FontWeight.w300),
                children: [
        ...
        if (subtitle.isNotEmpty)
          Padding(
            ...
            child: Text(
              subtitle,
              style: AppStyle.text1.copyWith(color: AppColors.sonaRed.withOpacity(0.7)),
            ),
          ),
      ],
    );
