    ...
    return AppTextField(
      ...
      suffixWidget: Padding(
        ...
        child: Icon(
          ...
          size: 24,
          color: filteredItems.isEmpty ? Colors.grey : Colors.grey.shade700,
        ),
      ),
      onTap: () async {
                            ...
                            children: [
                              ...
                              Expanded(
                                child: ListView.separated(
                                  ...
                                  separatorBuilder: (_, index) => Container(),//_separator,
                                  itemBuilder: (_, index) {
                                    return ListTile(
                                      contentPadding: EdgeInsets.symmetric(
                                        horizontal: 20.w,
                                      ...
                                      onTap: () {
                                        // setState(() {
                                        controller.text = filteredItems[index].displayName!;
                                        // });
