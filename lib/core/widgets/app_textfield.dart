...
import 'package:nimble_simple/core/widgets/app_form_label.dart';
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            suffixIconConstraints: BoxConstraints(minHeight: 10.h, maxHeight: 20.h),
            ...
            // ),
            hintText: hintText,
            hintStyle: AppStyle.text1.copyWith(color: AppColors.sonaGrey3),
            isDense: true,
            filled: true,
            fillColor: enabled ? AppColors.sonaGrey6.withOpacity(0.5) : AppColors.sonaGrey6,
